<form method="Post">
    <div> <br>
    <h5>Para cadastrar um cliente, primeiro deve fazer o cadastro do usuário.</h4> 
...
<div class="container"> 
    <form method="Post">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="CpfCli" name="CpfCli" aria-describedby="nomeHelp" required>
        </div>


        <div class="mb-3">
            <label for="nomeCli" class="form-label">Nome</label>
            <input type="text" class="form-control" id="nomeCli" name="nomeCli" aria-describedby="nomeHelp" required>
        </div>

        <div class="mb-3">
            <label for="fone" class="form-label">Fone</label>
            <input type="text" class="form-control" id="fone" name="foneCli" required>
        </div>
